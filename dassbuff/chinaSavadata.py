...
# 时间 盘口 当前进球数 类型 金额   第三行开始样本太少，要关注
    bet_data=[[3,2,0,'大',10],[37,2.25,1,'大',10],[25,2.5,0,'大',40],[22,2.5,1,'大',40],[30,2.75,1,'大',10],[21,3,1,'大',10],[23,3.5,1,'大',10],\
                [3,1.75,0,'小',10],[13,3,0,'小',10],[5,3.25,0,'小',10],[22,3.25,1,'小',10],\
                [11,3.75,1,'大',40],[21,3.75,2,'大',40],[27,4,2,'大',10],\

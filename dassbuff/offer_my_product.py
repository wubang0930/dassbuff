...
# 获取当前的库存
def get_my_invert_List(title="",limit=50):
    result_list=[]
    try:
        # 设置请求的URL
...
if __name__ == '__main__':
    # 获取当前的采购饰品情况
    my_invert_list=get_my_invert_List(title="Kilowatt Case",limit=100)
    ...
    # # 获取当前的出售单
    # my_invert_list=get_my_offer_List(title="Kilowatt Case",limit=100)
    # print(my_invert_list)
    # if my_invert_list is None or len(my_invert_list) == 0: 
    #     print("获取当前的出售单情况失败")
    #     exit()
